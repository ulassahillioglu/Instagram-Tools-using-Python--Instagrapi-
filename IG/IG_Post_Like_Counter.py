...
shared_media = bot.media_pk_from_url(user_input)

time.sleep(10)
media_info = bot.media_info(shared_media).dict()

try:
    print("Like Count = " + str(media_info['like_count']) + " " +" View Count = " + str(media_info['view_count']))

except Exception as e:
    print(e)
    print(media_info["like_count"])
